...
var TxtType = function(el, toRotate, period) {
        ...
        this.deletingSpeed = 40; // faster deletion
        this.delayBeforeDelete = this.period; // pause before deleting
        this.delayBetweenWords = 600; // pause between words
        this.tick();
    };
    ...
    TxtType.prototype.tick = function() {
        ...
        if (!this.isDeleting && this.txt === fullTxt) {
            ...
            delta = this.delayBeforeDelete;
            this.isDeleting = true;
        } else if (this.isDeleting && this.txt === '') {
            // Finished deleting - move to next word
            this.isDeleting = false;
            this.loopNum++;
            delta = this.delayBetweenWords;
        }
    ...
    window.onload = function() {
        ...
        // INJECT CSS for smooth typing effect
        var css = document.createElement("style");
        css.type = "text/css";
        css.innerHTML = ".typewrite > .wrap { border-right: 2px solid var(--orange-soda); padding-right: 2px; animation: blink 0.7s infinite; } @keyframes blink { 0%, 49% { border-right-color: var(--orange-soda); } 50%, 100% { border-right-color: transparent; } }";
